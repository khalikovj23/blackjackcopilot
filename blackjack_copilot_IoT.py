...
def
basic_strategy (player_hand_total, dealer_upcard):
  blackjack_table = { 
#Hard totals
...
#Place for object detection
#need to implement object detection using OpenCV
...
camera =
  cv2.
VideoCapture (0)
#Here we have to include the camera setup - JOHN 
